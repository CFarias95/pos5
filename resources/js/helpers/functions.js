...
function calculateRowItem(row_old, currency_type_id_new, exchange_rate_sale, pigv = null, currency_type_id_def = null, change_currency = 0) {
    ...
    let row = {
        ...
        income_retention: (row_old.retention_type_id_income) ? _.round(row_old.income_retention,2) : -1,
        iva_retention: (row_old.retention_type_id_iva) ? _.round(row_old.iva_retention,2) : -1,

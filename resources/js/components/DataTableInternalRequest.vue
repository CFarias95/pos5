                    ...
                    <div class="col-lg-2 col-md-2">
                        <div class="form-group">
                            ...
                            <el-select v-model="search.estado" popper-class="el-select-document_type" filterable clearable>
                                <el-option value="Created" label="Creado"></el-option>
                                <el-option value="Acepted" label="Aceptado"></el-option>
                                <el-option value="Rejected" label="Rechazado"></el-option>
                            </el-select>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2">
                        <div class="form-group">
                            ...
                            <el-select v-model="search.manager" popper-class="el-select-document_type" filterable clearable>
                                <el-option v-for="option in managers" :key="option.id" :value="option.id" :label="option.name"></el-option>
                            </el-select>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-2">

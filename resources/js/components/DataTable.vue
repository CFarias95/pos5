        ...
        <div class="row" v-if="applyFilter">
          ...
          <div class="col-lg-3 col-md-4 col-sm-12 pb-2">
            ...
            <template v-else-if="search.column === 'category_id_array'">
              ...
              >
                <el-option
                  v-for="(category, index) of category_list"
                  :key="index"
                  :label="category.name"
                  :value="category.id"
                >

            ...
            <div class="form-body">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            <label class="control-label">
                                ...
                                <el-tooltip class="item" effect="dark"
                                    content="Cliente relacionado al establecimiento creado" placement="top">
                                    <i class="fa fa-info-circle"></i>
                                </el-tooltip>
                            </label>

                            <el-select v-model="form.customer_associate_id" filterable remote
                    ...
                    <div class="col-md-4">
                        <div :class="{ 'has-danger': errors.rate_id }" class="form-group">
                            ...
                            <el-select v-model="form.rate_id" clearable filterable>
                                <el-option v-for="option in rates" :key="option.id" :label="option.rate_name"
                                    :value="option.id"></el-option>
                            </el-select>
                            <small v-if="errors.rate_id" class="form-control-feedback" v-text="errors.rate_id[0]"></small>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-lg-6 col-md-6 form-group" style="padding-top: 29px;">
                        ...
                        <input type="file" ref="inputFile" class="hidden" @change="onSelectImage"

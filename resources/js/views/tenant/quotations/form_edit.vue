                                            ...
                                            <tr v-for="(row, index) in form.items" :key="index">
                                                ...
                                                <td>{{ setDescriptionOfItem(row.item) }}
                                                    {{ row.item.presentation && row.item.presentation.hasOwnProperty('description') ?
                                                        row.item.presentation.description : '' }}<br /><small>{{
                                                        row.affectation_igv_type.description }}</small>
                                                </td>
    ...
    async created() {
        ...
        await this.$http.get(`/${this.resource}/tables`)
            .then(response => {
                ...
                this.options = response.data.internalRequests
        ...
        initRecord() {
            this.$http.get(`/${this.resource}/record/${this.resourceId}`)
                .then(response => {
                    ...
                    this.form.internal_request = dato.internal_request

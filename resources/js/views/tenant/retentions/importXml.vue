                    ...
                    <div class="col-md-12 mt-4">
                        <div :class="{ 'has-danger': errors.file }" class="form-group text-center">
                            <el-upload ref="upload" :auto-upload="false" :limit="1" :multiple="false"
                                :on-change="handleChange" :show-file-list="true" accept=".xml" action="''">
                                <el-button slot="trigger" type="success">Seleccione un archivo (XML)</el-button>
                            </el-upload>
...
export default {
    ...
    methods: {
        ...
        MensajeError(campo) {
            this.$message.error(`${campo} No se ha encontrado el xml, no se puede continuar`);
        ...
        async submit() {
            this.loading_submit = true;
            await this.$http
                .post(`/${this.resource}/importxml`, this.formXmlJson)
                .then(response => {

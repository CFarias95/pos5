        ...
        <el-tabs v-model="activeName">
          <el-tab-pane class name="first">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div :class="{ 'has-danger': errors.rate_id }" class="form-group">
                  <label class="control-label"> Tarifa </label>
                  <el-select v-model="form.rate_id" clearable filterable>
                    <el-option
            ...
            <div class="row mt-2" v-if="config.enable_discount_by_customer">
              <div class="col-lg-4 col-md-4">
                <label class="control-label"> ¿Tiene descuento? </label>
                <div
                  :class="{ 'has-danger': errors.has_discount }"
              ...
              <div class="col-lg-4 col-md-4">
                <div :class="{ 'has-danger': errors.discount_type }" class="form-group">
              ...
              <div class="col-lg-4 col-md-4">
                <div :class="{ 'has-danger': errors.discount_amount }" class="form-group">
                  <label class="control-label"
                    >Descuento ({{
                      form.discount_type === "01" ? "Monto" : "Porcentaje"
                    }})</label
                  >
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <el-input v-model="form.mobile_number" dusk="mobile_number"></el-input>
                </div>
              </div>
          ...
          <el-tab-pane class name="third">
            ...
            <div class="row">
              ...
              <div class="col-md-6" v-if="this.type === 'suppliers'">
                <div :class="{ 'has-danger': errors.parteRel }" class="form-group">
                  <label class="control-label"> Relacionado </label>
                  <el-select v-model="form.parteRel" clearable>
                    <el-option
                      v-for="option in parteRel"
                      :key="option.id"
                      :label="option.name"
                      :value="option.name"
                      >{{ option.name }}
                  ...
                  <small
                    v-if="errors.parteRel"
                    class="form-control-feedback"
                    v-text="errors.parteRel[0]"
                  ></small>
                </div>
              </div>
              ...
              <div class="col-md-6" v-if="this.type === 'suppliers'">
                <div :class="{ 'has-danger': errors.pagoLocExt }" class="form-group">
                  <label class="control-label"> Pago local exterior </label>
                  <el-select v-model="form.pagoLocExt" clearable>
                    <el-option
                      v-for="option in pagoLocExt"
                      :key="option.id"
                      :label="option.name"
                      :value="option.name"
                      >{{ option.name }}
                  ...
                  <small
                    v-if="errors.pagoLocExt"
                    class="form-control-feedback"
                    v-text="errors.pagoLocExt[0]"
                  ></small>
                </div>
              </div>
              ...
              <div
                class="col-md-6"
                v-if="this.type === 'suppliers' && form.pagoLocExt == 'Exterior'"
              >
                <div :class="{ 'has-danger': errors.pagoLocExtDoc }" class="form-group">
                  <label class="control-label"> Tipodocumento(solo extrajeros) </label>
                  <el-select v-model="form.pagoLocExtDoc" clearable>
                    <el-option
                      v-for="option in pagoLocExtDoc"
                      :key="option.id"
                      :label="option.name"
                      :value="option.name"
                      >{{ option.name }}
                  ...
                  <small
                    v-if="errors.pagoLocExtDoc"
                    class="form-control-feedback"
                    v-text="errors.pagoLocExtDoc[0]"
                  ></small>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-4 col-md-4" v-if="company && company.countable">
                <div :class="{ 'has-danger': errors.account }" class="form-group">
                  <label class="control-label"> Cuenta clientes </label>
                  <el-select v-model="form.account" clearable>
                    ...
                    >
                      <span style="float: left">
                        {{ option.code }} - {{ option.description }}</span
                      >
                    </el-option>
                  </el-select>
                </div>
              ...
              <div class="col-md-4">
                <div :class="{ 'has-danger': errors.credit_quota }" class="form-group">
                  ...
                  ></el-input-number>
                  <small
                    v-if="errors.credit_quota"
                    class="form-control-feedback"
                    v-text="errors.credit_quota[0]"
                  ></small>
                </div>
              </div>
              <div class="col-md-4">
                <div :class="{ 'has-danger': errors.default_payment }" class="form-group">
              ...
              <div class="col-md-4" v-if="this.type === 'suppliers'">
                ...
                >
                  ...
                  <small
                    v-if="errors.taxpayer_type_id"
                    class="form-control-feedback"
                    v-text="errors.taxpayer_type_id[0]"
                  ></small>
                </div>
              </div>
            </div>

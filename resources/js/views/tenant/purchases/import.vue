      ...
      <form autocomplete="off" @submit.prevent="submit">
        <div class="form-body">
          <div class="row">
            ...
            <div
              class="col-md-12 mt-12"
              v-if="has_file && form.items && form.items.length > 0"
                  ...
                  <tr v-for="(item, index) in form.items" style="text-align: center">
                    ...
                    <td style="align-content: center">
                      <el-select
                        ...
                        @change="changeItem(item.item_id, index)"
                        filterable
                        required="true"
                      >
                        <!-- :remote-method="searchRemoteItems" remote> -->
                        <el-option
                          v-for="(prod, index2) in items_all"
                          :key="index2"
                          :value="prod.id"
                          :label="prod.full_description"
                        ></el-option>
                      </el-select>
                    </td>
                  </tr>

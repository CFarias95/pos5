  ...
  <div>
    <div class="page-header pr-0">
      ...
      <ol class="breadcrumbs">
        <li class="active"><span>Balance Resultados</span></li>
      </ol>
    </div>
    <div class="card-header bg-info">
      <h3 class="my-0">Balance Resultados</h3>
    </div>
    <div class="card mb-0">
      <div class="card-body">
    ...
    getRecords() {
      return this.$http
        ...
        .then((response) => {
          ...
          this.balance_header = this.records[this.records.length - 1];

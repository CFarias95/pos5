    ...
    <div v-if="loading_form">
      <form autocomplete="off" class="row no-gutters" @submit.prevent="submit">
        <div class="col-xl-9 col-md-9 col-12">
          <div
            class="row card-header no-gutters align-items-start"
          ...
          >
            ...
            <div class="col-xl-6 col-md-6 col-12 pl-2 align-self-center">
              <address class="mb-0" style="line-height: initial">
                ...
                <br />
                <span v-if="establishment && establishment.address != '-'"
                  >{{ establishment.address }}
                </span>
                <br />
                <span v-if="establishment && establishment.email != '-'"
                  >{{ establishment.email }} </span
                ><span v-if="establishment && establishment.telephone != '-'"
          ...
          <div class="card-body no-gutters">
            <div class="row">
              ...
              <div class="col-lg-2 align-self-end">
                ...
                >
                  <label class="control-label"
                    ...
                    <template
                      v-if="
                        (form.operation_type_id == '1001' ||
                          form.operation_type_id == '1004') &&
                        has_data_detraction
                      "
                    >
                      <a
              ...
              <div class="col-lg-2 align-self-end" v-if="!configuration.send_auto">
                <div :class="{ 'has-danger': errors.aproved }" class="form-group">
          ...
          <div class="card-body border-top no-gutters">
            <div class="row">
              ...
              >
                <p class="fs-point-system">
                  ...
                  <template v-if="total_exchange_points > 0">
                    - <b style="color: red">{{ total_exchange_points }}</b> =
              ...
              <!-- sistema por puntos -->
              <!-- Traslados -->
              <div class="form-group col-sm-6 mb-0 mt-3" v-if="this.form.traslados > 0">
                <p>
                  <label class="font-weight-bold text-info"
                    ><b style="color: red"
                      >Cliente tiene {{ this.form.traslados }} traslados pendientes</b
                    ></label
                  >
                  <b></b>
                </p>
                  ...
                  <tr v-for="(row, index) in form.items" :key="index">
                    ...
                    <td>
                      ...
                      >
                        <el-checkbox
                          ...
                          ><b>{{ getExchangePointDescription(row) }}</b></el-checkbox
                        >
                      </template>
                      <!-- sistema por puntos -->
                    </td>
                    ...
                    <td class="text-right">
                      <template v-if="config.change_free_affectation_igv">
                        ...
                        >
                          <el-checkbox
                            v-model="row.item.change_free_affectation_igv"
                            @change="changeRowFreeAffectationIgv(row, index)"
                          ></el-checkbox>
                        </el-tooltip>
                      </template>
                      <button
                      ...
                      <div class="row table-responsive">
                        ...
                        >
                          ...
                          <tr v-if="form.total_exportation > 0">
                            ...
                            <td>
                              {{ currency_type.symbol }} {{ form.total_exportation }}
                            </td>
                          </tr>
                          ...
                          <tr v-if="form.total_service_taxes > 0">
                            <td>SERVICIO:</td>
                            <td>
                              {{ currency_type.symbol }} {{ form.total_service_taxes }}
                            </td>
                          </tr>
                          ...
                          <tr v-if="form.total > 0">
                            ...
                            <td>
                              ...
                              <el-input-number
                                ...
                                :disabled="
                                  config.active_allowance_charge == true ? true : false
                                "
                                :min="0"
                                class="input-custom"
                                controls-position="right"
                          ...
                          <template v-if="form.has_retention">
                            ...
                            <tr v-if="form.retention.amount > 0">
                              <td>
                                M. RETENCIÓN ({{ form.retention.percentage * 100 }}%):
                              </td>
                              <td>
                                {{ currency_type.symbol }} {{ form.retention.amount }}
                              </td>
                            </tr>
                            <tr v-if="form.total > 0">
                              ...
                              <td>
                                {{ currency_type.symbol }}
                                {{ form.total - form.retention.amount }}
                              </td>
                            </tr>
                          </template>
                          <template v-if="!form.has_retention">
                            ...
                            <td class="p-0" colspan="2">
                              ...
                              >
                                ...
                                >
                                  <thead>
                                    <tr>
                                      <th v-if="form.fee.length > 0" style="width: 120px">
                                        Método de pago
                                      </th>
                                      <th class="text-left" style="width: 100px">
                                        Fecha
                              ...
                              <div
                                v-if="
                                  !is_receivable && form.payment_condition_id === '01'
                                "
                                class="table-responsive"
                              >
                              ...
                              >
                                ...
                                <p
                                  ...
                                  v-if="cuenta_pagar > 0"
                                >
                                  Pendiente a pago: {{ currency_type.symbol }}
                                  <b>{{ cuenta_pagar }} </b>
                                </p>
                                <p style="color: red; margin-bottom: 2px; width: 70%">
                                  Cupo de crédito: {{ currency_type.symbol }}
                                  <b>{{ cupo_credito }}</b>
                                </p>
                                <p style="color: red; margin-bottom: 2px; width: 70%">
                        ...
                        <table class="text-left">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td colspan="5">
                                <label class="control-label">
                                  <a class="" href="#" @click.prevent="clickAddPayment"
          ...
          <div class="card-footer hidden-md-up">
            <div class="col-12 row text-center">
              <div class="col-6 text-center">
                <button class="btn btn-default form-control" @click.prevent="close()">
                  Cancelar
                </button>
              </div>
              <div class="col-6 text-center">
            ...
            <div class="col-12">
                          ...
                          <div class="form-group">
                            ...
                            <table style="width: 100%">
                              ...
                              <tr>
                                <td colspan="3">
                                  <label class="control-label">
                                    <a class="" href="#" @click.prevent="clickAddGuide"
                                      ><i
                                        class="fa fa-plus font-weight-bold text-info"
                                      ></i>
              ...
              <div v-if="isActiveBussinessTurn('transport')" class="">
                ...
                >
                  <button
                    class="btn btn-primary btn-block"
                    @click.prevent="clickAddDocumentTransport"
                  >
                    Datos de transporte
                  </button>
                </el-tooltip>
              ...
              <button
                ...
                @click.prevent="visibleDialogReportCustomer"
              >
...
export default {
  ...
  async created() {
    ...
    await this.$http.get(`/${this.resource}/tables`).then((response) => {
      ...
      this.traslados_list = response.data.transfers;
      //console.log("logs", this.traslados_list);
  ...
  methods: {
    ...
    changeRowExchangePoints(row, index) {
      ...
      row.item.used_points_for_exchange = row.item.change_free_affectation_igv
    ...
    async changeRowFreeAffectationIgv(row, index) {
      if (row.item.change_free_affectation_igv) {
        ...
        this.form.items[index].affectation_igv_type_id = this.form.items[
          index
    ...
    disabledSeries() {
      return (
        this.configuration.restrict_series_selection_seller && this.typeUser !== "admin"
      );
    },
    setDefaultSerieByDocument() {
      if (this.authUser.multiple_default_document_types) {
        const default_document_type_serie = _.find(this.authUser.default_document_types, {
...
<<<<<<< HEAD
    ...
    inputAmountPrepayment(index) {
      ...
      if (
        parseFloat(this.form.prepayments[index].amount) > parseFloat(prepayment.amount)
      ) {
      ...
      if (this.form.affectation_type_prepayment == 10) {
        ...
        if (global_discount > 0 && !discount) {
          ...
          this.form.discounts.push({
            discount_type_id: "04",
            description:
              "Descuentos globales por anticipos gravados que afectan la base imponible del IVA/IVAP",
            factor: factor,
            amount: amount,
            base: base,
          });
    ...
    clickRemovePrepayment(index) {
      ...
      this.changeTotalPrepayment();
      if (this.form.prepayments.length == 0) this.deletePrepaymentDiscount();
    },
    ...
    initialValueATPrepayment() {
      this.form.affectation_type_prepayment = !this.form.affectation_type_prepayment
        ? 10
    ...
    getDocumentsPrepayment() {
      this.$http
        .get(`/${this.resource}/prepayments/${this.form.affectation_type_prepayment}`)
        .then((response) => {
...
>>>>>>> 015db6bbf191a028b850c015729ee9a9c62fc33b
        }
      ...
      if (this.form.detraction) {
        if (this.form.currency_type_id == "PEN") {
          ...
          this.form.total_pending_payment = _.round(
            this.form.total - this.form.detraction.amount / this.form.exchange_rate_sale,
            2
          );
        }
    ...
    async selectDefaultCustomer() {
      if (this.establishment.customer_id) {
        ...
        let temp_customers = this.customers;
        await this.$http
          .get(`/${this.resource}/search/customer/${this.establishment.customer_id}`)
          .then((response) => {
            let data_customer = response.data.customers;
            temp_all_customers = temp_all_customers.push(...data_customer);
            temp_customers = temp_customers.push(...data_customer);
    ...
    calculateTotal() {
      ...
      this.form.total_taxes = _.round(
        total_igv + total_isc + total_plastic_bag_taxes + total_service_taxes,
        2
      );
    ...
    chargeGlobal() {
      ...
      if (amount > 0 && !charge) {
        ...
        this.form.total = _.round(
          base + this.form.total_taxes + this.form.total_charge,
          2
        );
        ...
        if (this.isGlobalDiscountBase) {
          ...
          this.form.total_taxes = _.round(
            this.form.total_igv +
              ...
              this.form.total_service_taxes,
            2
          );
          this.form.total = _.round(
            this.form.total_tsetGlobalDiscountaxed + this.form.total_taxes,
            2
          );
          this.form.subtotal = this.form.total;
    ...
    async submit() {
      ...
      if (this.config.enabled_point_system) {
        ...
        if (!validate_exchange_points.success)
          return this.$message.error(validate_exchange_points.message);
      }
      // validacion sistema por puntos
    ...
    /*bringTransfers() {
      this.$http.get(`/${this.resource}/traslados`).then((response) => {
        console.log("transfers ", response);
        this.traslados_list = response.data.traslados;
      });
    },*/
    changeCustomer() {
      this.customer_addresses = [];
      ...
      this.traslados_list.forEach((row) => {
        //console.log("row", row);
        if (
          Number(row.client_id) === Number(this.form.customer_id) &&
          row.estado_id == "Registrada"
        ) {
          traslados_cliente.push(row);
        }
      });

      let tamanio = traslados_cliente.length;

      this.form.traslados = tamanio;

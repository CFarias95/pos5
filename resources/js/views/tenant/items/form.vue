      ...
      <el-tabs v-model="activeName">
          ...
          <div class="row">
            <div class="col-md-3">
              <div v-show="show_has_igv" class="">
                <div :class="{ 'has-danger': errors.has_igv }" class="form-group">
                  <el-checkbox v-model="form.has_igv">Incluye IVA </el-checkbox>
                  <br />
                  <small
                    v-if="errors.has_igv"
            ...
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.tariff_id }" class="form-group">
                ...
                <small
                  v-if="errors.tariff_id"
                  class="form-control-feedback"
                  v-text="errors.tariff_id[0]"
                ></small>
              </div>
            </div>
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.concept_id }" class="form-group">
                ...
                <small
                  v-if="errors.concept_id"
                  class="form-control-feedback"
                  v-text="errors.concept_id[0]"
                ></small>
              </div>
            </div>
            <div class="col-12">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div
                          v-show="
                            form.unit_type_id != 'ZZ' && form.series_enabled && !recordId
                          "
                        >
                          <div
                            :class="{ 'has-danger': errors.lot_code }"
            ...
            <div class="col-md-3">
              <div class="">
                <div
                  :class="{ 'has-danger': errors.has_service_taxes }"
                  class="form-group"
                >
                  ...
                  <br />
                  <small
                    v-if="errors.has_service_taxes"
                    class="form-control-feedback"
                    v-text="errors.has_service_taxes[0]"
                  ></small>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div :class="{ 'has-danger': errors.category_id }" class="form-group">
                    ...
                    <el-cascader
                      v-model="form.category_id_array"
                      :options="categories"
                      @change="handleChange"
                    />
        ...
        <el-tab-pane class name="five">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div
                :class="{ 'has-danger': errors.purchase_mean_cost }"
                class="form-group"
              >
                ...
                <small
                  ...
                  class="form-control-feedback"
                  v-text="errors.purchase_mean_cost[0]"
                ></small>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.purchase_has_isc }" class="form-group">
                <el-checkbox v-model="form.purchase_has_isc" @change="purchaseChangeIsc"
                  >Incluye ISC
                </el-checkbox>
                <br />
                <small
          ...
          <div class="row">
            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.purchase_cta }" class="form-group">
                ...
                <small
                  v-if="errors.purchase_cta"
                  class="form-control-feedback"
                  v-text="errors.purchase_cta[0]"
                ></small>
              </div>
            </div>
            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.sale_cost_cta }" class="form-group">
                ...
                <small
                  v-if="errors.sale_cost_cta"
                  class="form-control-feedback"
                  v-text="errors.sale_cost_cta[0]"
                ></small>
              </div>
            </div>
            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.income_cta }" class="form-group">
                ...
                <small
                  v-if="errors.income_cta"
                  class="form-control-feedback"
                  v-text="errors.income_cta[0]"
                ></small>
              </div>
            </div>
            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.item_process_cta }" class="form-group">
                ...
                <small
                  v-if="errors.item_process_cta"
                  class="form-control-feedback"
                  v-text="errors.item_process_cta[0]"
                ></small>
              </div>
            </div>
            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.item_finish_cta }" class="form-group">
                ...
                <small
                  v-if="errors.item_finish_cta"
                  class="form-control-feedback"
                  v-text="errors.item_finish_cta[0]"
                ></small>
              </div>
            </div>
            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.item_import_cta }" class="form-group">
                ...
                <small
                  v-if="errors.item_import_cta"
                  class="form-control-feedback"
                  v-text="errors.item_import_cta[0]"
                ></small>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-7 col-lg-7 col-xl-7 col-sm-7">
              ...
              <el-input-number
                ...
                width="25%"
                v-model="form.total_producir"
                @change="calcularCantidad()"
                :min="0"
              ></el-input-number>
            </div>
            <div
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(row, index) in form.supplies" :key="index">
                      ...
                      <td>
                        <el-input-number
                          v-model="row.percentage_decimal"
                          @change="calcularCantidad()"
                        ></el-input-number>
                      </td>
                      <td>
                      ...
                      <td
                        v-else-if="
                          row.individual_item.unit_type != undefined ||
                          row.individual_item.unit_type != null
                        "
                      >
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td v-if="noSaveForm == true" style="color: red">
                        {{ porcentajeT }}
                      </td>
...
export default {
  ...
  methods: {
    ...
    clickDeleteRate(id) {
      this.$http
        .delete(`/${this.resource}/item-rate/${id}`)
        .then((res) => {
          if (res.data.success) {
            this.loadRecord();
    ...
    setDataToItemWarehousePrices() {
      ...
      this.form.item_warehouse_prices = _.orderBy(this.form.item_warehouse_prices, [
        "warehouse_id",
      ]);
    },
    loadRecord() {
    ...
    calculatePercentageOfProfitBySale() {
      let difference =
        parseFloat(this.form.sale_unit_price) - parseFloat(this.form.purchase_unit_price);

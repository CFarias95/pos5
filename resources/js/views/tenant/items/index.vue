<template>
  <div>
      ...
      <div class="right-wrapper pull-right">
        <template v-if="typeUser === 'admin'">
          <div class="btn-group flex-wrap">
            ...
            >
              <a class="dropdown-item text-1" href="#" @click.prevent="clickExport()"
                >Listado</a
              >
              <a class="dropdown-item text-1" href="#" @click.prevent="clickExportWp()"
                >Woocommerce</a
              >
              <a
          ...
          <div class="btn-group flex-wrap">
            ...
            <div
              ...
              x-placement="bottom-start"
            >
              <a class="dropdown-item text-1" href="#" @click.prevent="clickImport()"
                >Productos</a
              >
              <a
                class="dropdown-item text-1"
    ...
    <div class="card mb-0">
      ...
      <div class="card-body">
        <data-table :productType="type" :resource="resource">
          <tr slot="heading" width="100%">
            ...
            <th
              v-if="columns.sanitary !== undefined && columns.sanitary.visible === true"
            >
              R.S.
            </th>
            <th
              v-if="
                columns.cod_digemid !== undefined && columns.cod_digemid.visible === true
              "
            >
              DIGEMID
            </th>
            ...
            <th
              v-if="
                columns.extra_data !== undefined && columns.extra_data.visible === true
              "
              class="text-center"
            >
            ...
            <th
              v-if="typeUser != 'seller' && columns.purchase_unit_price.visible"
              class="text-right"
            >
              P.Unitario (Compra)
            </th>
            <th v-if="columns.real_unit_price.visible" class="text-center">P. venta</th>
            <!-- JOINSOFTWARE -->
            <th class="text-center">Incluye IVA (Venta)</th>
            <!-- JOINSOFTWARE -->
            <th v-if="columns.purchase_has_igv_description.visible" class="text-center">
              Incluye IVA (Compra)
            </th>
          ...
          <tr slot-scope="{ index, row }" :class="{ disable_color: !row.active }">
            ...
            <td v-if="columns.real_unit_price.visible" class="text-center">
              ...
              <div class="dropdown">
                ...
                <div aria-labelledby="dropdownMenuButton" class="dropdown-menu">
                  <template v-if="typeUser === 'admin'">
                    ...
                    <button class="dropdown-item" @click.prevent="duplicate(row.id)">
                      Duplicar
                    </button>
                    <button
                      v-if="row.active"
                    ...
                    <button class="dropdown-item" @click.prevent="clickBarcode(row)">
                      Cod. Barras
                    </button>
                    <button class="dropdown-item" @click.prevent="clickPrintBarcode(row)">
                      Etiquetas
                    </button>
      ...
      <items-export-extra :showDialog.sync="showExportExtraDialog"></items-export-extra>
      <warehouses-detail
      ...
      ></tenant-item-aditional-info-modal>
      <items-history :recordId="recordId" :showDialog.sync="showDialogHistory">
      </items-history>
    </div>
  </div>
</template>
...
export default {
  props: ["configuration", "company", "typeUser", "type"],
  mixins: [deletable],
  components: {
    ItemsForm,
    ItemsImport,

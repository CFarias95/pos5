              ...
              >
                ...
                <th>
                  <el-input-number
                    ...
                    v-bind:class="{
                      'text-danger': row.compromise_quantity > row.quantity,
                    }"
                  ></el-input-number>
                </th>
                <th>{{ row.code }}</th>
    ...
    quantityCompleted() {
      return (
        this.lots_group_
          ...
          .reduce((accum, item) => accum + Number(item.quantity), 0) >= this.quantity
      );
    },
    toAttend() {
      return _.round(
        this.quantity -
          this.lots_group_
            ...
            .reduce((accum, item) => accum + Number(item.compromise_quantity), 0),
        6
      );
    },
  },

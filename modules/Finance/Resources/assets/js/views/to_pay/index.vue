              ...
              <div>
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-3">
                    <div class="form-group">
                      <br />
                      <el-checkbox v-model="include_liquidated" @change="changeLiquidated"
                        >Incluir Liquidadas</el-checkbox
                      >
                    </div>
                  </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <template v-for="(row, index) in records">
                        <tr
                          v-if="include_liquidated == false && row.total_to_pay > 0"
                          :key="index"
                        >
                          <td>{{ index + 1 }}</td>

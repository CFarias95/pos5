                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Penalidad</th>
                                                    <th>Guías</th>
                                                    <th class="text-center" v-if="columns.web_platforms.visible">Plataforma
                                                    </th>
                                                    ...
                                                    <tr v-if="row.total_to_pay > 0" :key="index">
                                                        ...
                                                        <!--<td>
                                                            <el-popover placement="right" width="300" trigger="click">
                                                                ...
                                                                <p>
                                                                    Fecha ultimo pago:
                                                                    <span class="custom-badge">{{ row.date_payment_last ?
                                                                        row.date_payment_last : 'No registra pagos.'
                                                                    }}</span>
                                                                </p>
                                                        ...
                                                        <td class="text-right">
                                                            <template v-if="row.type === 'document'">
                                                                <button type="button" style="min-width: 41px"
                                                                    ...
                                                                    @click.prevent="clickDocumentPayment(row.fee_id, row.id, row.customer_id)">Pagos</button>
                                                            </template>
                                                            <template v-else>
                                                                <button type="button" style="min-width: 41px"
                                                                    class="btn waves-effect waves-light btn-xs btn-info m-1__2"

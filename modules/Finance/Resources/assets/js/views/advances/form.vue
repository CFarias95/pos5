      ...
      <div class="form-body">
        <el-tabs v-model="activeName">
          <el-tab-pane class name="first">
            ...
            <div class="row">
              <div class="col-md-4">
                <div :class="{ 'has-danger': errors.idMethodType }" class="form-group">
                  <label class="control-label">Tipo</label>
                  <el-select v-model="form.idMethodType" filterable :disabled="in_use">
                    <el-option
                      v-for="option in methodTypes"
                      :key="option.id"
                  ...
                  <small
                    v-if="errors.idMethodType"
                    class="form-control-feedback"
                    v-text="errors.idMethodType[0]"
                  ></small>
                </div>
              </div>
              <div class="col-md-4">
                <div :class="{ 'has-danger': errors.id_payment }" class="form-group">
                  <label class="control-label">Forma de pago</label>
                  <el-select v-model="form.id_payment" filterable :disabled="in_use">
                    <el-option
                      v-for="option in methodTypes2"
                      :key="option.id"
                      :label="option.description"
                      :value="option.id"
                    ></el-option>
                  ...
                  <small
                    v-if="errors.id_payment"
                    class="form-control-feedback"
                    v-text="errors.id_payment[0]"
                  ></small>
                </div>
              </div>
              <div class="col-md-4">
                <div :class="{ 'has-danger': errors.is_supplier }" class="form-group">
                  ...
                  />
                  <small
                    v-if="errors.is_supplier"
                    class="form-control-feedback"
                    v-text="errors.is_supplier[0]"
                  ></small>
                </div>
              </div>
              <div class="col-md-4">
                <div :class="{ 'has-danger': errors.idCliente }" class="form-group">
                  ...
                  <small
                    v-if="errors.idCliente"
                    class="form-control-feedback"
                    v-text="errors.idCliente[0]"
                  ></small>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    initForm() {
      ...
      (this.in_use = false), (this.resource = "finances/advances");
    },
    async opened() {},
    changeTipy() {

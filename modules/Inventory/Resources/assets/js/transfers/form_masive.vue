        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <el-date-picker v-model="form.created_at" type="datetime"></el-date-picker>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <template v-else>
                ...
                <a
                  ...
                  class="text-center font-weight-bold text-info"
                  href="#"
                  @click.prevent="clickSeriesOutput"
    ...
    clickAddItem() {
      ...
      if (this.form_add.lots_enabled) {
        ...
        if (this.form_add.quantity != quantityLots) {
          return this.$message.error(
            "La cantidad de lotes seleccionados es diferente a la cantidad de traslado"
          );
        }
      }

                ...
                <div class="card-body">
                    <div class="row m-b-10">
                        <div class="col-md-4 mb-3">
                            ...
                            <el-select v-model="form.warehouse_id" placeholder="Seleccionar almacén"
                                @change="changeWarehouse">
                                <el-option key="all" label="Todos" value="all"></el-option>
                                <el-option v-for="opt in warehouses" :key="opt.id" :label="opt.description" :value="opt.id">
                                </el-option>
                            </el-select>
                        </div>
                        <div v-if="filters.categories.visible" class="col-md-3">
                            <label class="control-label">Categoría</label>
                            <el-select v-model="form.category_id" clearable filterable placeholder="Seleccionar categoría"
                                @change="changeFilter">
                        ...
                        <div v-if="filters.brand.visible" class="col-md-3">
                            ...
                            <el-select v-model="form.brand_id" clearable filterable placeholder="Seleccionar marca"
                                @change="changeFilter">
                        ...
                        <div class="col-md-3">
                            ...
                            <el-select v-model="form.filter" placeholder="Seleccionar filtro" @change="changeFilter">
                                ...
                                <el-option key="06" label="Stock < Stock mínimo" value="06"></el-option>
                                <el-option key="07" label="Stock <= Stock mínimo" value="07"></el-option>
                            </el-select>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <el-select v-model="form.category_id" filterable clearable @change="changeFilter">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <el-select v-model="form.brand_id" filterable clearable @change="changeFilter">
                        ...
                        <div v-if="filters.range.visible" class="col-md-3">
                            ...
                            <el-date-picker v-model="form.date_start" :clearable="true" format="dd/MM/yyyy" type="date"
                        ...
                        <div v-if="filters.range.visible" class="col-md-3">
                            ...
                            <el-date-picker v-model="form.date_end" :clearable="true" :picker-options="pickerOptionsDates"
                        ...
                        <div class="col-auto">
                            <el-button :disabled="records.length <= 0" :loading="loadingPdf" @click="clickExport('pdf')"><i
                                    class="fa fa-file-pdf"></i> Exportar PDF
                            </el-button>
                        </div>
                        <div class="col-auto">
                            <el-button :disabled="records.length <= 0" :loading="loadingXlsx"
                                ...
                                <table class="table table-striped table-responsive-xl table-bordered table-hover">
                                    <thead class="">
                                        <tr>
                                            ...
                                            <th>Ganancia
                                                <el-tooltip class="item" content="Precio de venta - Costo" effect="dark"
                                                    placement="top-start">
                                                    <i class="fa fa-info-circle"></i>
                                                </el-tooltip>
                                            </th>
                                            <th>Ganancia Total
                                                <el-tooltip class="item" content="Precio de venta - Costo * Cantidad"

<template>
  <div>
    ...
    <div class="card mb-0">
            ...
            <th>
              <el-dropdown>
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item @click.native="onChecktAll"
                    >Seleccionar todo</el-dropdown-item
                  >
                  <el-dropdown-item @click.native="onUnCheckAll"
                    >Deseleccionar todo</el-dropdown-item
                  >
                  <el-dropdown-item @click.native="onOpenModalMoveGlobal"
                    >Trasladar</el-dropdown-item
                  >
                  <el-dropdown-item @click.native="onOpenModalStockGlobal"
      ...
      <movement-report :showDialog.sync="showDialogMovementReport"></movement-report>
      ...
      <stock-report :showDialog.sync="showDialogStockReport"></stock-report>
    </div>
  </div>
</template>

  ...
  <div>
    <div class="page-header pr-0">
      ...
      <ol class="breadcrumbs">
        <li class="active"><span>Reporte Recetas - Kits</span></li>
      </ol>
    </div>
    <div class="card-header bg-info">
      <h3 class="my-0">Reporte Recetas - Kits</h3>
    </div>
    <div class="card mb-0">
      <div class="card-body">
        ...
        <div class="col-md-12">
          <div class="table-responsive">
            <table class="table">
              <thead>
                <slot
                  v-for="(key, value) in receta_headers"
  ...
  methods: {
    ...
    getRecords() {
      return this.$http.get(`/${this.resource}/datosSP`).then((response) => {
        ...
        this.receta_headers = this.records[this.records.length - 1];

<template>
    <div class="card mb-0 pt-2 pt-md-0">
                ...
                <el-dropdown :hide-on-click="false">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item v-for="(column, index) in columns" :key="index">
                            <el-checkbox v-model="column.visible" :disabled="column.disable">{{ column.title
                                }}</el-checkbox>
                        </el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
        ...
        <div class="card mb-0">
            <div class="card-body">
                <data-table :defaultType="defaultType" :applyConversionToPen="applyConversionToPen"
                    :resource="resource">
                    <tr slot="heading">
                        <th class="">#</th>

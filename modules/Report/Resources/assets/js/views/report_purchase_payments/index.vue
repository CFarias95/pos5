<template>
    <div class="card mb-0 pt-2 pt-md-0">
        <div class="card-header bg-info">
            <h3 class="my-0">Reporte Pagos</h3>
        </div>
        <div class="card mb-0">
            <div class="card-body">
                <template>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <el-select v-model="form.supplier_id" clearable>
                                                <el-option label="Todos los proveedores" :value="0" :key="0"></el-option>
                                                <el-option v-for="option in persons" :key="option.id" :label="option.name"
...
export default {
    ...
    data() {
        return {
            ...
            pagination: {},
            resource: 'reports/report_purchase_payments',
            form: {
                desde: null,
                hasta: null,
                supplier_id: 0,

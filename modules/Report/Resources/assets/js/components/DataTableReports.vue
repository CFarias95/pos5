    ...
    <div class="row">
      <div class="col-md-12 col-lg-12 col-xl-12">
        <div class="row mt-2">
          ...
          >
            <div class="form-group">
              <label class="control-label">
                {{
                  resource == "reports/sales" || resource == "reports/state-account"
                    ? "Clientes"
                    : "Proveedores"
                }}
              </label>
          ...
          <div
            v-if="resource == 'reports/sales' || resource !== 'reports/state-account'"
          ...
          <div
            v-if="
              resource == 'reports/quotations' || resource !== 'reports/state-account'
            "
            class="col-lg-3 col-md-3"
          >
            <div class="form-group">
          ...
          <div class="col-lg-7 col-md-7 col-md-7 col-sm-12" style="margin-top: 29px">
            ...
            <template
              v-if="records.length > 0 && resource !== 'reports/document-detractions'"
            >
              <el-button
                v-if="resource != 'reports/state-account'"
                class="submit"
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            >
              <template
                v-if="
                  resource == 'reports/sales' || this.resource === 'reports/state-account'
                "
              >
                <tr>
                  <td :colspan="13"></td>
...
export default {
  ...
  async mounted() {
    ...
    this.form.type_person =
      this.resource === "reports/sales" || this.resource === "reports/state-account"
        ? "customers"
        : "suppliers";
  },
  methods: {
    ...
    searchRemotePersons(input) {
      if (input.length > 0) {
        ...
        this.$http
          .get(`/reports/data-table/persons/${this.form.type_person}?${parameters}`)
          .then((response) => {

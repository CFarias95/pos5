...
if ($hostname) {
    ...
    Route::domain($hostname->fqdn)->group(function () {
        ...
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
            ...
            Route::get('items/brands', 'Tenant\ItemController@brands');
            ...
            Route::post('retentions/importxml', 'Tenant\RetentionController@importXml');
            ...
            Route::get('imports/liquidation-report-excel/{id}', 'Tenant\ImportsController@liquidationsReportExcel');
            ...
            Route::prefix('internal-request')->group(function () {
                ...
                Route::get('','Tenant\InternalRequestController@index')->name('tenant.internal-request.index');                ;
                Route::post('','Tenant\InternalRequestController@store');
